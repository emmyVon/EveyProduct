      ...
      <div className="single-p ">
        <div className="container">
          ...
          <div className=" grid grid-cols-1 lg:grid-cols-2 gap-5 max-h-screen">
            <div className="max-h-[calc(50vh-5rem)] lg:max-h-[calc(70vh-5rem)] w-[90%]  lg:w-full justify-self-center">
              <img
                src={image}
                alt="product"
            ...
            <div className="flex flex-col text-white items-center lg:items-start gap-3 w-full lg:w-3/4 ">
              ...
              <h3 className="font-semibold text-sm lg:text-3xl">{title}</h3>
              ...
              <p className="text-sm lg:text-xl text-center lg:text-left opacity-80 leading-8">
                {description}
              </p>
            </div>
          </div>
